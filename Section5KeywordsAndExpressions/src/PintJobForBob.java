...
*/
    ...
    public static  int getBucketCount(double width, double height, double areaPerBucket, int extraBuckets ){
        ...
        double requiredPaint = Math.ceil (((width * height) /areaPerBucket) - extraBuckets);
        int convertedIntoInteger = (int)(Math.round(requiredPaint));

        return convertedIntoInteger ;
    }
    ...
    public static int getBucketCount(double width, double height, double areaPerBucket){
        ...
        double requiredPaint = Math.ceil (((width * height) /areaPerBucket) );
        int convertedIntoInteger = (int)(Math.round(requiredPaint));
    ...
    public static int getBucketCount(double area, double areaPerBucket){
        ...
        double requiredPaint = Math.ceil ((area /areaPerBucket) );
        int convertedIntoInteger = (int)(Math.round(requiredPaint));
